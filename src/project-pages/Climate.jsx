      ...
      <div className="individualProjectMainContent">
        ...
        <div className="imgAndDescription">
          <div className="projectIndvImg">
            <img
              src="/project-images/rooLogo.png"
              alt=""
            ...
            <div className="liveGit">
              <div className="live">
                ...
                <a
                  className="livea"
                  href="https://sweet-selkie-37c150.netlify.app"
                  rel="noreferrer"
                  target="_blank"
                >
                  Live
              ...
              <div className="git">
                ...
                <a
                  className="gita"
                  href="https://github.com/patrickmctighe/virtual-store"
                  rel="noreferrer"
                  target="_blank"
                >
                  Git
          ...
          <div className="projectDescriptionAndTech">
            <div className="projectDescription">
              <p>
                This project constitutes an online store specializing in the
                sale of weather control systems. It is a highly reactive site
                that demonstrates extensive use of props and setStates.
                Furthermore, it serves as an excellent example of React Router
                functionality, showcasing the synergistic effects achieved by
                integrating both React and vanilla JavaScript functions.
              </p>
            </div>
